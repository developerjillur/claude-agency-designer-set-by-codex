...
Twenty queries: ten that should load nexa-script and ten that should route to another skill. Run each in a fresh Claude Code
...
3. **Skill:** a second fresh session writes it following nexa-script's fast path (and its client level for finals).
